...
<Link  className="text-[#4edea3] font-bold font-headline transition-colors duration-300" to="/">Health</Link>
<Link  className="text-[#dae2fd]/70 font-headline hover:text-[#4edea3] transition-colors duration-300" to="/intake">History</Link>
<Link  className="text-[#dae2fd]/70 font-headline hover:text-[#4edea3] transition-colors duration-300" to="/history">Consult</Link>
<Link  className="text-[#dae2fd]/70 font-headline hover:text-[#4edea3] transition-colors duration-300" to="/">Settings</Link>
</nav>
...
<Link  className="flex items-center gap-4 px-6 py-4 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-2 transition-all duration-300" to="/share">
<span className="material-symbols-outlined">dashboard</span>
<span className="text-sm">Overview</span>
</Link>
<Link  className="flex items-center gap-4 px-6 py-4 bg-[#131b2e] text-[#4edea3] border-l-4 border-[#4edea3]" to="/">
<span className="material-symbols-outlined">mic_external_on</span>
<span className="text-sm">Symptom Checker</span>
</Link>
<Link  className="flex items-center gap-4 px-6 py-4 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-2 transition-all duration-300" to="/">
...
{/* Main Canvas */}
<main className="lg:ml-64 pt-16 h-screen relative flex flex-col overflow-hidden">
...
<img className="w-full h-full object-contain blur-[2px]" data-alt="futuristic semi-transparent 3D anatomical human model with glowing nodes on chest and head, deep slate background, ethereal medical aesthetic" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBhVIz5SZh-HV2p4I2Jw57pmxZ7R_HUzHGdfz_RvZ36NTGSZkwnKGYuPdMxqbzNx3ekwvX6Kh4wm_7Dbr_UvbZ9f07u1TAYJXkzk53cLh05w49CfRywowoeD8ERGiomPAy2QcYo5fbFPxdrwkb4RiZlHAvTCWu1mxc86z9DiS3yfyyhyrXUlfOtwESjzqj2QEsu3jIuZoIuyWtAK7IgXPsWSrpNG9--SkFy39q4PEFdaXlBM3eVfs0z7Q6tpTaZWUT718ihnTwUajx5"/>
...
<div className="col-span-3 h-[500px] glass-panel rounded-3xl p-6 border border-outline-variant/5 flex flex-col">
...
<span className="material-symbols-outlined text-on-primary text-4xl" className="fill-current">mic</span>
</div>
...
<div className="flex items-center justify-between mt-auto bg-surface-container-lowest/40 backdrop-blur-md p-6 rounded-[2rem] border border-outline-variant/10">
<div className="flex gap-4">
<button className="flex items-center gap-3 px-6 py-3 bg-surface-container-high hover:bg-surface-container-highest text-on-surface rounded-xl border border-outline-variant/10 transition-all">
...
<button className="px-8 py-3 bg-gradient-to-br from-primary to-primary-container text-on-primary font-headline font-black rounded-xl shadow-lg hover:scale-[1.02] active:scale-95 transition-all">
...
<span className="material-symbols-outlined" className="fill-current">monitoring</span>
<span className="font-['Inter'] text-[10px] uppercase tracking-[0.05em] font-semibold mt-1">Health</span>
</Link>
<Link  className="flex flex-col items-center justify-center text-[#dae2fd]/50 px-4 py-2 tap-highlight-none active:scale-95 transition-transform duration-200" to="/">
