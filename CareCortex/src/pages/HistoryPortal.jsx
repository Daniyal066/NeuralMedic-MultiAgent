...
<Link  className="text-[#4edea3] font-bold transition-colors duration-300 font-headline text-lg tracking-tight" to="/">Health</Link>
<Link  className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300 font-headline text-lg tracking-tight" to="/intake">History</Link>
<Link  className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300 font-headline text-lg tracking-tight" to="/history">Consult</Link>
</div>
...
<Link  className="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-4" to="/">
<span className="material-symbols-outlined text-lg">dashboard</span>
<span className="text-sm">Overview</span>
</Link>
<Link  className="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-4" to="/share">
<span className="material-symbols-outlined text-lg">mic_external_on</span>
<span className="text-sm">Symptom Checker</span>
</Link>
<Link  className="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 bg-[#131b2e] text-[#4edea3] border-l-4 border-[#4edea3] pl-4" to="/">
