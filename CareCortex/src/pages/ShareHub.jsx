...
<Link  className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300 font-['Inter'] text-sm font-medium" to="/">Health</Link>
<Link  className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300 font-['Inter'] text-sm font-medium" to="/intake">History</Link>
<Link  className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300 font-['Inter'] text-sm font-medium" to="/history">Consult</Link>
<Link  className="text-[#4edea3] font-bold font-['Inter'] text-sm" to="/">Doctor Access</Link>
</div>
...
<Link  className="flex items-center gap-3 px-4 py-3 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-2 transition-all duration-300 rounded-xl" to="/share">
<span className="material-symbols-outlined">dashboard</span>
<span className="font-['Inter'] text-sm">Overview</span>
</Link>
<Link  className="flex items-center gap-3 px-4 py-3 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-2 transition-all duration-300 rounded-xl" to="/">
...
<Link  className="flex items-center gap-3 px-4 py-3 bg-[#131b2e] text-[#4edea3] border-l-4 border-[#4edea3] rounded-r-xl" to="/">
