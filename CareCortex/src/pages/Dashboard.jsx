...
<Link  className="text-[#4edea3] font-bold hover:text-[#4edea3] transition-colors duration-300" to="/">Health</Link>
<Link  className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300" to="/intake">History</Link>
<Link  className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300" to="/history">Consult</Link>
<Link  className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300" to="/">Settings</Link>
</div>
...
<Link  className="flex items-center gap-3 px-4 py-3 bg-[#131b2e] text-[#4edea3] border-l-4 border-[#4edea3] font-['Inter'] text-sm transition-all duration-300" to="/share">
<span className="material-symbols-outlined">dashboard</span> Overview
            </Link>
<Link  className="flex items-center gap-3 px-4 py-3 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-6 transition-all duration-300 font-['Inter'] text-sm" to="/">
...
<span className="material-symbols-outlined" className="fill-current">auto_awesome</span>
</div>
</div>
...
<circle cx="96" cy="96" fill="none" r="80" stroke="#4edea3" stroke-dasharray="502" stroke-dashoffset="380" strokeLinecap="round" strokeWidth="12"></circle>
</svg>
...
<Link  className="flex flex-col items-center justify-center bg-gradient-to-br from-[#4edea3]/20 to-[#10b981]/10 text-[#4edea3] rounded-xl px-4 py-2 tap-highlight-none active:scale-95 transition-transform duration-200" to="/">
<span className="material-symbols-outlined">monitoring</span>
<span className="font-['Inter'] text-[10px] uppercase tracking-[0.05em] font-semibold mt-1">Health</span>
</Link>
<Link  className="flex flex-col items-center justify-center text-[#dae2fd]/50 px-4 py-2 tap-highlight-none active:scale-95 transition-transform duration-200 hover:text-[#4edea3]" to="/">
