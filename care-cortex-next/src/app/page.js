...
const Dashboard = async () => {
  // Fetch from the Python backend via Next.js Server Components instantly
...
<Link prefetch={false}   className="text-[#4edea3] font-bold hover:text-[#4edea3] transition-colors duration-300" href="/">Health</Link>
...
<img alt="Patient Profile Avatar" className="h-full w-full rounded-full object-cover" data-alt="Close up portrait of a middle aged man with glasses in a professional medical setting with soft blue lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC3ezEF42AoVNEHHtH6EvIfI6NajjmNoRDQmKdSTVQtw0G6t7Sw4X9s7Hn7L7jiTYa1NbgWYi-g5awjD4QzduHuwH1YUEuOdvtUwU4zq7rj2ldMEwpGcUbxNVc2uFgTx1gxwNPSKLKwdNmelnOErbkgfxm-pwpPoyii4ph5M4AwYUp7nTL8--BjUubkkrON3_CpeiKSRUA7OmB8PPzk6ma4tzdQjjkV4XU5EIUhDtnkqHFr-NFeeOxCY6b-Ru-w0dp_fL9yU1m1On5e"/>
</div>
</div>
</div>
</nav>
...
<Link prefetch={false}   className="flex items-center gap-3 px-4 py-3 bg-[#131b2e] text-[#4edea3] border-l-4 border-[#4edea3] font-['Inter'] text-sm transition-all duration-300" href="/">
<span className="material-symbols-outlined">dashboard</span> Overview
            </Link>
<Link prefetch={false}   className="flex items-center gap-3 px-4 py-3 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-6 transition-all duration-300 font-['Inter'] text-sm" href="/intake">
<span className="material-symbols-outlined">mic_external_on</span> Symptom Checker
            </Link>
<Link prefetch={false}   className="flex items-center gap-3 px-4 py-3 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-6 transition-all duration-300 font-['Inter'] text-sm" href="/history">
<span className="material-symbols-outlined">folder_managed</span> Medical Records
            </Link>
<Link prefetch={false}   className="flex items-center gap-3 px-4 py-3 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-6 transition-all duration-300 font-['Inter'] text-sm" href="/">
<span className="material-symbols-outlined">biotech</span> Lab Results
            </Link>
<Link prefetch={false}   className="flex items-center gap-3 px-4 py-3 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-6 transition-all duration-300 font-['Inter'] text-sm" href="/share">
...
{/* Agent Monologue (High Priority Alert) */}
...
<p className="text-on-surface-variant leading-relaxed max-w-3xl whitespace-pre-wrap">
...
{/* Grid: Trajectory & Risk */}
<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
{/* Metabolic Trajectory (Chart Section) */}
...
{/* Wellness Roadmap (CommercePulse Integration) */}
...
<img alt="Activity Suggestion" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" data-alt="Modern yoga studio with soft morning light, minimalist design, and natural wood floors with professional yoga mats" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAYIujSaiNEMsBy4105WnTTBLq5PsDbNED6LpUGEP91SJknLeEQ4xEdBDLuVKWXDKlRCYkyGQv9efNbLB0cMEmlEWtxAJmwAtmb5PZ3foT7t6hQ0LwV-qJ9G_S-Frwa9gf-J0tIFaL772f5Xl18cx9Bhp0vNHV9_FVNqb4pBsoh72kjP6bQq2S1h5t505SXyslj7qgHBUkL32RY5-rjuesLAty1VWby896_c75TXxmGvpaxu0tQwc3IboucsS2kK_2trEDzbXkx8EoN"/>
...
<div className="group bg-surface-container-low rounded-3xl overflow-hidden flex flex-col transition-all hover:-translate-y-1">
<div className="h-40 relative">
<img alt="Diet Suggestion" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" data-alt="Top-down view of a vibrant Mediterranean salad with fresh greens, olives, feta, and olive oil in a dark ceramic bowl" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDSu6-Z4fic2fvQAdlHKE8Is5-XIuo5jlDEdzkFzuVgXIHnzaQBtH1HPAqb7kMPVig_m_EVvIgASZq3-95chMpKWfQeXpo3g9dHHh6rU9HEkvij2SqbNSk_SoFBiQ5E7J-WNXYdmbe1uxcfMgwmlQyHZChAgDGLy49rRiKOGzNw2ZVDfn5BeFW891UrCL9eaoJHJxszmoikvFQTF0vjWNj7iNdlg9Ki2_10ODD6dXN009L0ubsdJZCunsiy-DARDr4nFjEjuPLYPBNi"/>
<div className="absolute inset-0 bg-gradient-to-t from-surface-container-low to-transparent"></div>
...
<div className="group bg-surface-container-low rounded-3xl overflow-hidden flex flex-col transition-all hover:-translate-y-1">
<div className="h-40 relative">
<img alt="Supplement Suggestion" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" data-alt="Macro photography of high-quality hydration salts and clean glass of water on a slate surface with dramatic lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD-MVggw0SHJGbKhC5xCLStIuBGnqpImToUrJ2EJCAkOcbKMTAH-0FBCm2lz8IL4epTmxGQnjhTcCeLIe-OCuccsEEDSrTQNQ9ENLb0O7RU1l-HMPT97LFWmb8GwKY1M6xxterIp2YKfSAUcOmlFnjkgTTjAhj4To5liIZiDTLEOVl7aSJm7JDtibQDyaUQKk1l3FraJTJ1ani0lQvt4UQOjdVtxFgDQQU0t2z8wsPJpH8_sgAHin44Yj_C4zXZcEngp-rKaz4skOPr"/>
<div className="absolute inset-0 bg-gradient-to-t from-surface-container-low to-transparent"></div>
...
<Link prefetch={false}   className="flex flex-col items-center justify-center text-[#dae2fd]/50 px-4 py-2 tap-highlight-none active:scale-95 transition-transform duration-200 hover:text-[#4edea3]" href="/intake">
