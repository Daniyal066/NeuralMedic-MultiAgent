    ...
    <div className="bg-surface text-on-surface font-body selection:bg-primary/30 min-h-screen">
        ...
        <div className="flex justify-between items-center px-6 h-16 w-full">
          ...
          <div className="flex items-center gap-6">
            <div className="hidden md:flex gap-8">
              <Link className="text-[#4edea3] font-bold transition-colors duration-300 font-headline text-lg tracking-tight" href="/health">Health</Link>
              <Link className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300 font-headline text-lg tracking-tight" href="/history">History</Link>
              <Link className="text-[#dae2fd]/70 hover:text-[#4edea3] transition-colors duration-300 font-headline text-lg tracking-tight" href="/intake">Consult</Link>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="w-8 h-8 rounded-full overflow-hidden border border-primary/20">
                <img alt="Patient Profile Avatar" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDnmfR1qOv81nYwjZUv1VxjzZmyXC5GcSX7brS8zQRr5thQeBybny-_vEywlZOuG9nEYP0D5vrGSm_XHrp1qNKNh5bZqi6r4V8cWUTpuymtwSpooqZT2ZF76pG-eqRdE4Jz1Y8vMEK3d--McydhnGzLaJgKd5nQcX8Ugs3q5Hr5pFL5N-3umoryy3Vt4GuMOj-6JJwEYPuYn7gb8LNFU7ZFvTJOaOLlCdBTlQ19ziA1R6OoGA8BU2SCLWINVwCHALIlRpMq_o8Ar6A9" />
              </div>
            </div>
          </div>
        </div>
      ...
      <aside className="fixed left-0 top-0 z-40 h-full w-64 hidden lg:flex flex-col bg-[#0b1326] border-r border-[#3c4a42]/15 pt-20">
        ...
        <nav className="flex-1 space-y-1 px-3">
          <Link className="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 bg-[#131b2e] text-[#4edea3] border-l-4 border-[#4edea3] pl-4" href="/">
            <span className="material-symbols-outlined text-lg">dashboard</span>
            <span className="text-sm font-medium">Overview</span>
          </Link>
          <Link className="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-4" href="/intake">
            <span className="material-symbols-outlined text-lg">mic_external_on</span>
            <span className="text-sm">Symptom Checker</span>
          </Link>
          <Link className="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-4" href="/history">
            <span className="material-symbols-outlined text-lg">folder_managed</span>
            <span className="text-sm">Medical Records</span>
          </Link>
          <Link className="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-4" href="#">
            <span className="material-symbols-outlined text-lg">biotech</span>
            <span className="text-sm">Lab Results</span>
          </Link>
          <Link className="flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-300 text-[#dae2fd]/60 hover:bg-[#131b2e]/50 hover:pl-4" href="/share">
                ...
                <div>
                  ...
                  <div className="h-12 mt-3 w-full opacity-60">
                    <svg className="w-full h-full text-primary fill-none stroke-current stroke-1" viewBox="0 0 100 20">
                      <path d="M0 15 Q 10 5, 20 18 T 40 10 T 60 15 T 80 5 T 100 12" />
                      <path className="fill-primary/5 stroke-none" d="M0 15 Q 10 5, 20 18 T 40 10 T 60 15 T 80 5 T 100 12 V 20 H 0 Z" />
                    </svg>
                  </div>
                </div>
            ...
            <div className="bg-surface-container-low p-6 rounded-[2rem] border border-outline-variant/10">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full overflow-hidden">
                  <img className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBACYlkFjne_uCgepC3fXnb2945LfJ27iBhy-mIwzDrWFe-uOrenYNjpVIIWsatczF_400uD3a0dfM2BftpVsfshpQ3TG2xV8PJjH-__AKx4N0jVHNH10HpTvGKpZNvaGZY3pm9Jh6YuZJy1inDQCQlEWsZ0Mk4fYOeSWcEX1Ium8ZbVfydDmoE55CcbPa37wmzg5yfmXtc7ONpy21fRCxhRy82f8_9FqecaRVO7SNcxYIrNUXcanDFG-5DDblObiI_eIb9NwVqtPWA" />
                </div>
                <div>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-6 pt-2 bg-[#131b2e]/90 backdrop-blur-2xl border-t border-[#3c4a42]/10 shadow-[0px_-10px_30px_rgba(0,0,0,0.3)] rounded-t-3xl">
        <Link className="flex flex-col items-center justify-center bg-gradient-to-br from-[#4edea3]/20 to-[#10b981]/10 text-[#4edea3] rounded-xl px-4 py-2 tap-highlight-none active:scale-95 transition-transform duration-200" href="/">
        ...
        <Link className="flex flex-col items-center justify-center text-[#dae2fd]/50 px-4 py-2 tap-highlight-none active:scale-95 transition-transform duration-200" href="/intake">
